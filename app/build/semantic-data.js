...
function prefixLocations(prefix, locs) {
    Object.keys(locs).forEach(comp => locs[comp] = path_1.join(prefix, locs[comp]));
    return locs;
}
exports.prefixLocations = prefixLocations;
exports.nameLocations = {
