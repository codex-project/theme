...
class AntdScssThemePlugin {
    ...
    apply(compiler) {
        const afterEmit = (compilation, callback) => {
            ...
            if (theme) {
                ...
                else if (compilation.fileDependencies instanceof Set
    ...
    static themify(config) {
        ...
        switch (loader) {
            case 'sass-loader':
                overloadedLoader = require.resolve('./antdSassLoader');
                break;
            case 'less-loader':
                overloadedLoader = require.resolve('./antdLessLoader');
                break;
            default:
...
AntdScssThemePlugin.SCSS_THEME_PATH = '';
exports.AntdScssThemePlugin = AntdScssThemePlugin;
