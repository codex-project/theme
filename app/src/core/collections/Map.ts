...
import { extendable } from 'collections/extendImmutable';


const ExtendableMapper = extendable(Immutable.Map);

export interface Map<K, V> extends Immutable.Collection.Keyed<K, V> {
...
export class Map<K, V> extends (ExtendableMapper as any) {
    constructor(val?:any){
        super(val);
    }
}
