...
routes.addRoutes({
    ...
    path: url.root('/about'),
    exact: true,
    component: componentLoader(() => import(/* webpackChunkName: "pages.about" */ 'pages/AboutPage'), (loaded, props) => <loaded.default {...props}/>),
}, {
    name: 'home',
    path: url.root(),
    exact: true,
    ...
    component: componentLoader(() => import(/* webpackChunkName: "pages.document" */ 'pages/DocumentPage'), (loaded, props) => {
